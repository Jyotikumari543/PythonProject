...
class Student_Detail:      
     def __init__(self,root):
                 ...
                 #first image
                 img=Image.open("./images/stu1.jpeg")
              ...
              #second image
                 img1=Image.open("./images/stu2.jpeg")
               ...
               #third image
                 img2=Image.open("./images/stu3.jpeg")
                 ...
                 #bg image
                 img3=Image.open("./images/stu4.jpg")
                 ...
                 Left_frame.place(x=10,y=10,width=770,height=600)
                 
                 img_left=Image.open("./images/stu4.jpg")
                 img_left=img_left.resize((770,580),Image.ANTIALIAS) 
                 ...
                 current_course_frame.place(x=5,y=135,width=770,height=150)
                 #department
                 ...
                 #year
                 year_label=Label(current_course_frame,text="Course",font=("times new roman",12,"bold"))
                 ...
                 year_combo["values"]=("Select year","2012","2013","2014","2015","2020")
                 ...
                 Semester_combo["values"]=("Select Semester","1","2","3","4","5")
                 Semester_combo.current(0)
                 Semester_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)
            
                  #class student information
                 class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student information",font=("times new roman",12,"bold"))
                 class_student_frame.place(x=5,y=250,width=770,height=285)
                 #studentid
                 ...
                 radiobtn1=ttk.Radiobutton(class_student_frame,textvariable=self.var_radio1,text="take photo sampe",value="yes")
                 radiobtn1.grid(row=6 ,column=0)  
                 self.var_radio2=StringVar()
                 radiobtn2=ttk.Radiobutton(class_student_frame,textvariable=self.var_radio2,text="take photo sampe",value="no")
                 ...
                 btn_frame.place(x=0,y=200,width=780,height=35)
                 #save btn
                 ...
                 #delete btn
                 delete_btn=Button(btn_frame,text="Delete ",width=18,font=("times new roman",13,"bold"),bg="red",fg="white")
        ...
        #          #right label frame
                 ...
                 Right_frame.place(x=790,y=10,width=660,height=600)
                 
                 img_right=Image.open("./images/stud4.jpeg")
                 img_right=img_right.resize((770,580),Image.ANTIALIAS) 
